...
class App {
    ...
    fun playNumberGame(digitsToGuess: Int = 4) {
        ...
        do {
            ...
            val userNum = inputStr?.toIntOrNull() ?: throw IllegalArgumentException("Numbers only!")
            val result = checkUserInputAgainstGeneratedNumber(userNum, genNum)

            println("Correct Digits: ${result.n}, Correct Positions: ${result.m}")
    ...
    val generateRandomNonRepeatingNumber: (Int) -> Int = { length ->
        ...
        while (digits.size != length){
           digits.add(Random.nextInt(1,10))
        }
    ...
    val checkUserInputAgainstGeneratedNumber: (Int, Int) -> CompareResult = { input, generatedNumber ->
        ...
        CompareResult(correctDigitsCount, correctPositionsCount)
    }
}
